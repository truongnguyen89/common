...
CREATE TABLE `weather_info` (
  ...
  `s_temp_max` varchar(10) NOT NULL COMMENT 'nhiet do cao nhat',
  `s_pressure` varchar(10) COMMENT 'ap suat khi quyen(o muc nuoc bien, neu khong co du lieu sea_level hoac grnd_level), hPa',
  `s_sea_level` varchar(10) COMMENT 'ap suat khi quyen tren mat bien, hPa',
  `s_grnd_level` varchar(10) COMMENT 'ap suat khi quyen tren mat dat, hPa',
  `s_humidity` varchar(10) COMMENT 'do am %',
  `s_temp_kf` varchar(10) COMMENT 'tham so noi bo cua openweathermap.org',
  ...
  `s_clouds` varchar(10) COMMENT 'ty le % co may',
  `s_wind_speed` varchar(10) COMMENT 'toc do gio, don vi m/second',
  `s_wind_deg` varchar(10) COMMENT 'huong gio',
  `s_rain_1h` varchar(10) COMMENT 'luong mua 1h qua, don vi mm',
  `s_rain_3h` varchar(10) COMMENT 'luong mua 3h qua, don vi mm',
